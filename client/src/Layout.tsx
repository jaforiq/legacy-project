        ...
        <nav className="navbar bg-slate-900 bg-neutral text-neutral-content px-8">
          <div className="flex-1">
            <Link to="/" className="m-2">
              {" "}
              <div className="text-2xl font-bold text-primary hover:text-primary-focus transition-colors duration-300">
          ...
          <div className="flex-none gap-2">
            {context?.user ? (
              <>
                ...
                >
                  <i className="fa-solid fa-plus"></i> New Movie
                </button>
                <Link to="/user">
              ...
              <Link to="/login">
                <button className="btn bg-transparent btn-nav-l text-white min-h-0 h-auto py-3 rounded-full">
      ...
      <dialog id="my_modal_nav" className="modal text-black">
        <div className="modal-box">
          ...
          <section className="">
            <MovieForm
              setHomeRefresh={
                context?.setHomeRefresh
                  ? context?.setHomeRefresh
                  : setTooltipLeft
              }
              setListRefresh={
                context?.setListRefresh
                  ? context?.setListRefresh
                  : setTooltipLeft
              }
            />
